...
class MyGraph extends mxGraph {
   ...
   */
  _initActionState() {
    const selected = !this.isSelectionEmpty()
    ...
    const oneVertexSelected = vertexSelected && this.getSelectionCount() == 1
    this.actions
      .get('group')
  ...
  _setAnchors() {
    ...
    mxGraph.prototype.getAllConnectionConstraints = (terminal) => {
      if (terminal != null && terminal.cell != null && terminal.cell.isEdge()) { return [] }
  ...
  _initRotate() {
    ...
    const vertexHandlerCreateSizerShape
    ...
    this.popupMenuHandler.factoryMethod = (menu, cell, evt) => {
      ...
      if (cells.length > 0) {
        ...
        menu.addItem(
          '复制',
          undefined,
          this.actions.get('copy').func.bind(this, this),
        )
        menu.addItem(
          '粘贴',
          undefined,
          this.actions.get('paste').func.bind(this, this),
        )
        // menu.addItem(
        //   '取消组合',
        //   undefined,
        ...
        menu.addItem(
          '粘贴',
          undefined,
          this.actions.get('pasteHere').func.bind(this, this),
        )
      }
    }
  }
