...
function lifelinePerimeter(bounds, vertex, next, orthogonal) {
  let size = 60
  ...
  let sw
    = (Number.parseFloat(vertex.style[mx.mxConstants.STYLE_STROKEWIDTH] || 1)
      * vertex.view.scale)
    / 2
    - 1
...
mxStyleRegistry.putValue('lifelinePerimeter', lifelinePerimeter)
